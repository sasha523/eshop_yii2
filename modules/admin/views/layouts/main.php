...
<input type="checkbox" id="check">
    ...
    <header>
     ...
     <?= Html::img("@web/images/admin/icon-32.png{$product->img}",['alt' => 'Dior'])?>
      ...
      <a class="logout_btn" href="<?= \yii\helpers\Url::to(['/admin/auth/logout'])?>"><i class="fa fa-sign-out"></i><span> (Выход)</span></a>
      </div>
    ...
    <div class="mobile_nav">
      ...
      <a href="<?= \yii\helpers\Url::to(['/admin/default/index'])?>"><i class="fa fa-tachometer "></i><span>Панель управления</span></a>
        <a href="<?= \yii\helpers\Url::to(['/admin/order/index'])?>"><i class="fas fa-desktop"></i><span>Заказы</span></a>
        <a href="<?= \yii\helpers\Url::to(['category/index'])?>"><i class="fas fa-th"></i><span>Список категорий</span></a>
        <a href="<?= \yii\helpers\Url::to(['brand/index'])?>"><i class="fa fa-list"></i><span>Список брендов</span></a>
        <a href="<?= \yii\helpers\Url::to(['product/index'])?>"><i class="fa fa-shopping-cart"></i><span>Список товаров</span></a>     
